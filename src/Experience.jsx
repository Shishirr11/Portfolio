...
function FloatingObjects() {
    ...
    return <>
        <mesh ref={refs[0]} position={[-6,1,-3]}><torusGeometry args={[1,0.3,16,40]} /><meshStandardMaterial color="#ffffff" roughness={0.8} metalness={0.1} /></mesh>
        <mesh ref={refs[1]} position={[5,-2.5,-4]}><icosahedronGeometry args={[1.2,0]} /><meshStandardMaterial color="#ffffff" roughness={0.8} metalness={0.1} wireframe /></mesh>
        <mesh ref={refs[2]} position={[6,1.5,1]}><torusKnotGeometry args={[0.6,0.2,80,16]} /><meshStandardMaterial color="#ffffff" roughness={0.8} metalness={0.1} wireframe /></mesh>
    </>
}
...
export default function Experience({ onFullscreen }) {
    ...
    return <>
        <color args={['#2C5282']} attach="background" />
        ...
        >
            <Float rotationIntensity={phase === 'idle' ? 0.3 : 0} floatIntensity={isZoomed || isZooming ? 0 : 1} speed={isZoomed || isZooming ? 0 : 1}>
                <rectAreaLight width={2.5} height={1.65} intensity={8} color="#ffffff"
                ...
                <Text font="./bangers-v20-latin-regular.woff"
                    ...
                    rotation-y={-1.25} maxWidth={3} color="#ffffff"
                ...
                {screenReady && (
                    ...
                    >
                        <button onClick={onFullscreen} style={{
                            ...
                            color: '#000000', fontSize: '11px', fontWeight: 600,
